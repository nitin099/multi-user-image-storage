...
SECRET_KEY = "django-insecure--fw4ozcvq(@+gqtnbv9ccfek-h&5t-y_))0(w)mptn+=d_2p*d"
...
AWS_QUERYSTRING_AUTH = False  # Optional: Disable query strings in URLs for simplicity
